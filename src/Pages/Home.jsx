...
const Home = () => {
  ...
  const { loading, error, totalPages, products, filteredBrandDatamen } =
  ...
  useEffect(() => {
    ...
    dispatch(getMensProducts(currentPagemen));
    dispatch(getMainData());
    // }
  }, [dispatch, currentPagemen]);
          ...
          > */}
            {/* <div className={prodStyle.products}>
              ...
              >
                {checkedmen ? (
                  <>
                    {filteredBrandDatamen &&
                      filteredBrandDatamen?.map((prod) => (
